...
commentsRouter.put("/:commentId/like-status",authorizationCheck.accessTokenCheck,likeStatusValidator(),inputErrorCheckValidator,commentsController.likeComment)